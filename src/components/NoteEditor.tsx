    ...
    <div className={`transition-opacity duration-300 ${mounted ? 'opacity-100' : 'opacity-0'}`}>
      ...
      >
        <div className="bg-white dark:bg-[#1e2433] rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 h-full flex flex-col transition-colors duration-200">
          <div 
            className="handle flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 cursor-move rounded-t-lg bg-white dark:bg-[#1e2433] transition-colors duration-200"
          >
